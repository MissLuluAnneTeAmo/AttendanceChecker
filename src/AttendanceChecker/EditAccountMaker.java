...
public class EditAccountMaker extends JDialog
{
    JTextField name;
    JTextField id;
    JTextField section;
    ...
    JLabel codeLabel;
    JButton ok;
    public EditAccountMaker(Person p)
    {
        super();
        initializeComponent();
        panel = createPanel();
        ...
        id = createId(p.getId());
        section = createSection(p.getSection());
        code = createCode(p.getCode());
    ...
    private JTextField createName(String name)
    {
    ...
    private JTextField createId(String id)
    {
        JTextField field = new JTextField();
        field.setText(id);
    ...
    private JTextField createSection(String section)
    {
        JTextField field = new JTextField();
        field.setText(section);
        field.setFont(new Font("Arial", Font.PLAIN, 15));
        field.setLayout(null);
    ...
    private JTextField createCode(String code)
    {
        JTextField field = new JTextField();
        field.setText(code);
        field.setFont(new Font("Arial", Font.PLAIN, 15));
